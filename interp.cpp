...
static unordered_map<string,void*> font_map
{
...
shape_ptr interpreter::make_text (param begin, param end) {
   ...
   return make_shared<text> (itor->second, ret_string);
}
...
shape_ptr interpreter::make_polygon (param begin, param end) {
   ...
   auto itor = begin;
   while (itor != end) {
      vertex vtx {stof(*itor++), stof(*itor)};
